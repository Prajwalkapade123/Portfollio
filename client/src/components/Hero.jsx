    ...
    return (
        <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-[#0a0a0a] text-white pt-20">
            ...
            <div className="absolute top-0 left-0 w-full h-full overflow-hidden z-0">
                ...
                <div className="absolute top-[40%] left-[40%] w-[20%] h-[20%] bg-cyan-500/10 rounded-full blur-[100px]" />
            </div>
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 flex flex-col items-center text-center">
                ...
                >
                    Building Scalable Full-Stack <br className="hidden md:block" />
                ...
                >
                    ...
                    <div className="flex flex-wrap justify-center gap-8 opacity-70 grayscale hover:grayscale-0 transition-all duration-500">
                        {/* Icons placeholder names since we don't have all SVG logos ready, using text for now or Lucide if applicable */}
                        <span className="text-xl font-bold text-orange-500">Java</span>
                        <span className="text-xl font-bold text-yellow-400">JavaScript</span>
                        <span className="text-xl font-bold text-cyan-400">React</span>
                        <span className="text-xl font-bold text-green-500">Node.js</span>
                        <span className="text-xl font-bold text-green-400">MongoDB</span>
                        <span className="text-xl font-bold text-blue-400">Tailwind</span>
